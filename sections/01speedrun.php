<section id="speedrun">
        <div class="content-margins flex">
                ...
                <div class="barre"></div>
                <div class="right margin-bottom"><p class="linked" id="doomsupport"><img id="doomguy" src="./Assets/img/doomguy.png" alt="">This is how speedrunning was born. In November of the same year the COMPET-N website was created and becomes the cornerstone of the DOOM speedruning community.</p></div>
        </div>                
        <div class="content-margins flex">
        <div class="right">
            <h3>SPEEDRUN</h3>
