<section id="charitystreams">
        <h3>RISE OF SPEEDRUN CHARITY EVENTS</h3>
        <div>
                <img src="./assets/img/zevent.svg" alt="zevent" tag-inviewport="scale-in">
                ...
                <img id="livetime" src="./assets/img/livetime.svg" alt="livetime" tag-inviewport="scale-in">
